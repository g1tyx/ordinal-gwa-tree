...
var cnItems = {
    ...
    "Hepteract factor 7's effect": "因子 7 的效果 ^7",
    "Hierarchies": "阶层",
    ...
    "All factors are multiplied by the ordinal base (before reductions)": "所有因子都乘以序数基数（减少前）",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnRegReplace = new Map([
    ...
    [/^adding  ([\d\.]+) to$/, '增加 $1 到'],
    [/^([\d\.]+) elves$/, '$1 精灵'],
    [/^: ([\d\.]+), multiplying autoclicker speed by (.+)$/, '：$1，将 自动点击器速度 乘以 $2'],
    [/^: ([\d\.]+), multiplying booster power gain by (.+)$/, '：$1，将 助推器力量 增益乘以 $2'],
    [/^: ([\d\.]+), multiplying incrementy gain by (.+)$/, '：$1，将 增量 增益乘以 $2'],
    [/^: ([\d\.]+), multiplying psi ordinal gain by (.+)$/, '：$1，将 psi 序数 增益乘以 $2'],
    [/^: ([\d\.]+), multiplying SGH gain by (.+)$/, '：$1，将 SGH 增益乘以 $2'],
    [/^: ([\d\.]+), multiplying GP gain by (.+)$/, '：$1，将 GP 增益乘以 $2'],
    [/^: ([\d\.]+), multiplying FGH gain by (.+)$/, '：$1，将 FGH 增益乘以 $2'],
    [/^: ([\d\.]+), multiplying dynamic gain and cap by (.+)$/, '：$1，将动态增益和上限乘以 $2'],
