...
var cnItems = {
    ...
    "AutoBooster": "自动助推器",
    "Autobuy hierarchy buyables, unlock a new booster power effect, divide charge cost by e14, and multiply autobuyer speed by e100": "自动购买 层次结构 可购买，解锁一个新的助推器 力量效果，除以充能成本 e14，并且乘以自动购买器速度 e100",
    "Automatically buy factors and autobuyer scaling is 1.001x": "自动购买因素和自动购买者缩放比例为 1.001 倍",
    "Automatically max all autobuyers and quadrupler effect ^4": "自动最大化所有自动购买者和四倍效应 ^4",
    ...
    "Both Hierarchies are Maximized instantly. Their Successor gains are based on Incrementy Amount and Psi Ordinal respectively.": "两个层次结构都立即最大化。 他们的继任者收益分别基于增量和 Psi 序数。",
    "C1's base is 7 and gain 10x incrementy": "C1 的基数为 7，增量为 10 倍",
    "C5-8 completions multiply incrementy gain": "C5-8 完成乘增量增益",
    "Challenge completions boost psi ordinal gain. Currently: *9.85": "完成挑战会提升 psi 序数增益。 目前：*9.85",
    "Charge": "收费",
    ...
    "Hierarchies grow faster based on factor boosts": "基于因素的提升，层次结构增长得更快",
    "Incrementy": "增量",
    ...
    "Psi upgrade": "Psi升级",
    "raising": "提高",
    "Respec Charged upgrades": "Respec 收费升级",
    ...
    "Unlock charge (subtab of Hierarchies)": "解锁费用（层次结构的子选项卡）",
    "Unlock Hierarchies, and start with 1 autoclicker": "解锁层次结构，并从 1 个自动点击器开始",
...
var cnRegReplace = new Map([
    ...
    [/^Req: (.+) elves$/, '要求：$1 精灵'],
    [/^Reward: Factor (.+) slightly boosts Tier (.+) Automation$/, '奖励：因子 $1 略微提升了 层次结构 $2 自动化'],
    [/^Currently: (.+)x$/, '当前：$1x'],
