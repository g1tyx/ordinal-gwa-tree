...
var cnItems = {
    ...
    "There is exponentially rising decrementy that slows down your autobuyers. You can only manually increment up to an ordinal of gwa^2+1. GP is square rooted and you are stuck in C6": "递减量呈指数级增长，这会减慢您的汽车购买者的速度。 您只能手动递增到 gwa^2+1 的序数。 GP 是平方根的，你被困在 C6",
